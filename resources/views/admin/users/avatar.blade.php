  ...
  <form class="form-horizontal" id="user-avatar-form" method="post" enctype="multipart/form-data"
    ...
    <div class="form-group">
      ...
      <div class="controls col-md-8 controls">
        <img src="{{ filepath($user->avatar, 'avatar') }}" id="avatar-crop" width="250" height="250">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="controls col-md-8 controls">
        <p class="help-block">请上传 jpg|gif|png 格式的图片，建议图片尺寸为 250×250px，建议图片大小不超过<strong>2MB</strong>，<a
