<nav class="navbar navbar-expand-md navbar-light shadow-sm bbs-navbar">
  <div class="container">
    ...
    <button class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse"
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
            ...
            <img class="img-responsive img-circle" width="30px" height="30px" src="{{ cdn_aliyun(Auth::user()->avatar) }}">
