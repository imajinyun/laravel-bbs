    ...
    var methods = {
        ...
        isFirstInit: function() {
            ...
            if (tree.data('first_init') === undefined) {
                tree.data('first_init', $this.treegrid('getSetting', 'saveStateMethod').getter(tree.treegrid('getSetting', 'saveStateName')) === undefined);
            }
        ...
        saveState: function() {
            ...
            var stateArrayString = $this.treegrid('getSetting', 'saveStateMethod').getter($this.treegrid('getSetting', 'saveStateName')) || '';
            ...
            $this.treegrid('getSetting', 'saveStateMethod').setter($this.treegrid('getSetting', 'saveStateName'), stateArray.join(','));
            return $this;
        },
        /**
        ...
        restoreState: function() {
            var $this = $(this);
            var stateArray = $this.treegrid('getSetting', 'saveStateMethod').getter($this.treegrid('getSetting', 'saveStateName')).split(',');
