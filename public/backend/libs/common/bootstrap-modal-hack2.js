define(function (require, exports, module) {
  $(document).on('click.modal.data-api', '[data-toggle="modal"]', function (e) {
    ...
    if (url) {
      ...
      let $style = 'z-index:1041;width:60px;height:60px;position:absolute;top:50%;left:50%;margin-left:-30px;margin-top:-30px;'
      let $loadingImg = '<img src="' + imgUrl + '" class="modal-loading" style="' + $style + '">'
